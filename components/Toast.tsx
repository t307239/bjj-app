...
export default function Toast({ message, type = "success", duration = 2500, onClose, onUndo }: Props) {
  ...
  return (
    <div
      className={`fixed bottom-24 sm:bottom-6 left-1/2 -translate-x-1/2 z-50 px-4 py-2.5 rounded-xl text-sm font-medium shadow-lg transition-all duration-300 flex items-center gap-3 ${
