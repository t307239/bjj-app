    ...
    return (
      <div className="bg-red-950/60 border border-red-500/40 rounded-xl px-4 py-3 flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-red-300 text-sm font-semibold">Payment issue — Pro features paused</p>
          <p className="text-zinc-500 text-xs">Your last payment failed. Update your billing info to continue.</p>
        </div>
        <a
          href={PORTAL_URL}
          target="_blank"
  ...
  if (isPro) {
    return (
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-[11px] text-zinc-600">All Pro features unlocked</span>
      </div>
    );
  }
