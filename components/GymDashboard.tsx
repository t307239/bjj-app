...
export default function GymDashboard({ userId, gym: initialGym, isGymPro, stripeGymPaymentLink }: Props) {
  ...
  return (
    <div className="pb-6">
      ...
      {kickTarget && (
        <div className="fixed inset-0 z-dropdown flex items-center justify-center px-4 bg-black/60" role="dialog" aria-modal="true" aria-label={t("gym.removeMemberTitle")} onClick={() => setKickTarget(null)}>
