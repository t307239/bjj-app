...
export default function CsvBulkInvite({ gym, onUpgradeClick, upgrading, isGymPro }: Props) {
  ...
  return (
    <>
      ...
      {/* Modal */}
      {open && (
        <div className="fixed inset-0 z-dropdown flex items-start justify-center px-4 pt-8 pb-4 bg-black/70 overflow-y-auto" role="dialog" aria-modal="true" aria-label={t("gym.csvBulkTitle")} onClick={() => setOpen(false)}>
