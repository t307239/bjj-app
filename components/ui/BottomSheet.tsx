...
export default function BottomSheet({ isOpen, onClose, title, children }: Props) {
  ...
  return (
    <>
      {/* ── Backdrop ─────────────────────────────────────────────────────── */}
      <div
        className="fixed inset-0 z-modal-backdrop bg-black/60 animate-sheet-fade"
      ...
      {/* ── Sheet container ───────────────────────────────────────────────── */}
      <div
        className="fixed inset-x-0 bottom-0 z-modal md:inset-0 md:flex md:items-center md:justify-center md:px-4 pointer-events-none"
      >
