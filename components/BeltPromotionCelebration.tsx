...
export default function BeltPromotionCelebration({ fromBelt, toBelt, onClose }: Props) {
  ...
  return (
    <div
      className="fixed inset-0 z-dropdown flex items-end sm:items-center justify-center bg-black/80 backdrop-blur-sm"
      aria-modal="true"
      role="dialog"
    ...
    >
      ...
      {/* Modal card */}
      <div
        className="relative z-floating rounded-t-2xl sm:rounded-2xl p-8 max-w-sm w-full mx-0 sm:mx-4 text-center shadow-2xl max-h-[90vh] overflow-y-auto"
        style={{
