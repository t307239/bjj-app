    ...
    <div>
      ...
      {!initialLoading && techniques.length > 0 && (
        <div className="relative mb-3">
          ...
          />
          <svg
aria-hidden="true"             className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-zinc-400"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex gap-1 ml-2 flex-shrink-0">
                    {onTogglePin && (
                      ...
                      >
                        <svg aria-hidden="true" className="w-4 h-4" fill={technique.is_pinned ? "currentColor" : "none"} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
aria-hidden="true"                             className="w-4 h-4"
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-between pt-1">
              ...
              >
                <svg aria-hidden="true" className="w-4 h-4 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" /></svg> {t("training.prev")}
              </button>
              ...
              <button type="button"
                ...
                className="px-3 py-2 min-h-[44px] text-sm text-zinc-400 hover:text-zinc-100 hover:bg-zinc-800/50 rounded-md transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
              >
                {t("training.next")} <svg aria-hidden="true" className="w-4 h-4 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" /></svg>
              </button>
            </div>
          )}
        </div>
