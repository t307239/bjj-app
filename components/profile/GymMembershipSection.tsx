    ...
    <div className="bg-zinc-900 border border-white/10 rounded-xl p-4">
      <div className="flex items-center justify-between mb-3">
        <div>
          ...
          <p className="flex items-center gap-1 text-xs text-zinc-400 mt-0.5 max-w-[180px]">
            <svg aria-hidden="true" className="w-3 h-3 flex-shrink-0 text-zinc-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008z" />
            </svg>
            <span className="truncate" title={gymName ?? undefined}>{gymName ?? t("gym.unknownGym")}</span>
          </p>
        </div>
        <button type="button"
          ...
          <div className="grid grid-cols-2 gap-x-3">
            <div>
              ...
              {([1, 2, 3] as const).map((i) => (
                <p key={i} className="text-[10px] text-zinc-300 leading-relaxed">✅ {t(`gym.shareDataShieldVisible${i}`)}</p>
              ))}
            </div>
            <div>
