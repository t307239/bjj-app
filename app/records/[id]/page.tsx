          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <span className="text-xs text-gray-400 whitespace-nowrap">{durStr}</span>
              </div>
            </div>
          ...
          {comp && (
            <div className="bg-white/5 rounded-xl p-3 space-y-1">
              ...
              <p className="text-white text-sm font-medium">
                ...
                {t(`csv.${comp.result}`)}
                {comp.opponent && <span className="text-gray-400 ml-2">vs {comp.opponent}</span>}
              </p>
              {comp.finish && (
                <p className="text-gray-400 text-xs">{t("csv.header.finish")}: {comp.finish}</p>
              )}
              {comp.event && (
                <p className="text-gray-400 text-xs">{t("csv.header.event")}: {comp.event}</p>
              )}
            </div>
          )}
