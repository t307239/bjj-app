 ...
 */
export default function ReadPersistence({ slug }: ReadPersistenceProps) {
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs text-slate-400 mt-0.5 leading-snug">
          You were reading this article earlier.
        </p>
      ...
      <button
        onClick={dismiss}
        aria-label="Dismiss"
        className="text-slate-600 hover:text-slate-400 transition-colors shrink-0 p-1"
      >
